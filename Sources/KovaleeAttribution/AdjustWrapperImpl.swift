...
import KovaleeSDK
    ...
    final class AdjustWrapperImpl: NSObject, AttributionManager, Manager {
        ...
        func sendConversionValue(value: Int, coarseValue: String?, completion: @Sendable @escaping (Error?) -> Void) {
...
final class AdjustWrapperImpl: NSObject, AttributionManager, Manager {
    ...
    func sendConversionValue(value: Int, coarseValue: String?, completion: @escaping @Sendable ((any Error)?) -> Void) {
        completion(nil)
    }
